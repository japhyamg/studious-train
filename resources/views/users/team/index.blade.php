...
<div class="row g-4">
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header"><i class="bi bi-person-plus me-2"></i> Add Team Member</div>
            <div class="card-body">
                <form method="POST" action="{{ route('manage-team.add') }}">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm w-100"><i class="bi bi-person-plus me-1"></i> Add Member</button>
                </form>
            </div>
        </div>
    </div>
